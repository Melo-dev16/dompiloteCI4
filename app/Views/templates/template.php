...
<head>
    ...
    <link href="<?=base_url('vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css');?>" rel="stylesheet">
...
<input type="hidden" id="base_url" value="<?=base_url();?>">
  ...
  ?>
    ...
    <script src="<?=base_url('build/js/custom.js?v=2');?>"></script>
    <script src="<?=base_url('scripts.js?v=1');?>"></script>
