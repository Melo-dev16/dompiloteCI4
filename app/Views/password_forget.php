      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form action="<?=base_url('password_recovery');?>" method="POST">
              <h2>Récupérer votre mot de passe</h2>
              <div>
                <input name="email" type="email" class="form-control" placeholder="Adresse Email" required />
              </div>
              <div>
                <button type="submit" id="loginBtn" class="btn btn-default submit"><span>Récupérer</span></button>
                <a class="reset_pass" href="<?=base_url();?>">Retour à la connexion</a>
              </div>
