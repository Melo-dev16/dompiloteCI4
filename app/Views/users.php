        ...
        <div class="row">
          <div class="col-md-12">
            <form method="POST" action="#">
              ...
              <p>
                <button id="exportBtn" type="button" onclick="UploadCSV()" class="btn btn-primary btn-sm">Exporter <img alt="loading..." style="margin-bottom: 5px;display: none;" src="<?=base_url('public/assets/gear.gif');?>" width="20" height="20"></button>
              </p>
            </form>
          </div>
          <div class="col-md-12">
